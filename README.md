...
#ผลการทดลอง
## เมื่อกดคีย์บอร์ดจะได้ผลดังนี้
![](https://github.com/tbnoung/LAB-03/blob/master/17.PNG)
## เมื่อกดเมาส์ได้ผลดังนี้
![](https://github.com/tbnoung/LAB-03/blob/master/16.PNG)
